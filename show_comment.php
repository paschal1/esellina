 <?php
                                                ...
                                                $query = "SELECT cmt.comment_id AS comment_id, ux.firstname, ux.lastname, ux.pic, cmt.comment AS comment, cmt.timeCreated AS timeCreated FROM user_post_comment AS cmt INNER JOIN users AS ux ON cmt.user_id = ux.user_id WHERE cmt.post_id = {$post_id} LIMIT 4";
                            ...
                            <tr>
                                ...
                                <td bgcolor="#EDEFF4" style="padding-left:7;" colspan="2">
                                    <img src="esellina/uploads/<?php echo $user_pic; ?> " height="20px" width="20px"
                                        border-radius="50px" />
