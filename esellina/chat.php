<?php 
  ...
  if (isset($_SESSION['username'])) {
  	...
  	if (empty($chatWith)) {
  	 ...
  	 $chats = getChats($_SESSION['id'], $chatWith['user_id'], $dbconn);

  	 opened($chatWith['user_id'], $dbconn, $chats);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="d-flex
             ...
             align-items-center
             vh-100">
    <div class="w-600 shadow p-4 rounded">
    	<a href="home.php"
    	   class="fs-4 link-dark">&#8592;</a>

    	   <div class="d-flex align-items-center">
    	   	  <img src="uploads/<?=$chatWith['pic']?>"
    	   	       class="w-15 rounded-circle">

               <p style="font-size:16px;" class="display-4 fs-sm m-2">
