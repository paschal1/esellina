...
<head>
    <meta charset="utf-8">
    <title>Members - eSellina.com</title>
...
<body>
    <p><span style="color:rgb(73, 243, 30); font-size:medium;">e</span><span style="color:rgb(252, 156, 13);">Sellina</span></p>
     <?php 
                    $id = $_SESSION['id'];
          ...
          <table class="table manage-candidates-top mb-0">
            ...
            <tbody>
              ...
              <tr class="candidates-list">
                <td class="title"><a href="../chat.php?user=<?=$conversations['username']?>">
                  <div class="thumb">
                    <img class="img-fluid" src="../uploads/<?=$conversations['pic']?>" alt="">
                  </div>
                  <div class="candidate-list-details">
                    <div class="candidate-list-info">
                      <div class="candidate-list-title">
                        <h5 class="mb-0"><a href="#"><span><?=$conversations['firstname']?></span><?php echo ' '?><?=$conversations['lastname']?></span></a></h5>
                      </div>
                       </a>
