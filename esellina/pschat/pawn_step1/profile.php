        ...
        <div class="col-md-7">
            <div class="card p-3 py-4">
                ...
                <div class="text-center mt-3"> <span class="bg-secondary p-1 px-4 rounded text-white">Pro</span>
                    <h5 class="mt-2 mb-0">Nwokeocha Paschal</h5> <span>Web Developer</span>
                    <div class="px-4 mt-1">
                        <p class="fonts">I am the CEO of D-Starite Technology we deal on web development, Data Analysis, SEO & SEM and UI/UX </p>
                    </div>
